 ...
 * getToken 返回结果
 */
public class RCXMediaTokenResult {
    ...
    public RCXMediaTokenResult(Integer code, String token, String userId, String errorMessage) {
        this.code = code;
        this.token = token;
        this.userId = userId;
    ...
    public String toString() {
        return GsonUtil.toJson(this, RCXMediaTokenResult.class);
    }
}
